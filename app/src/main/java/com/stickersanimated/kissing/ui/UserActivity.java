...
import com.stickersanimated.kissing.adapter.UserAdapter;
    ...
    private void initUser() {
      ...
      Picasso.get().load(R.drawable.profile).error(R.drawable.profile).placeholder(R.drawable.profile).into(this.image_view_profile_user_activity);
        ...
        if (prf.getString("LOGGED").toString().equals("TRUE")) {
            ...
            if (id == me) {
                button_follow_user_activity.setVisibility(GONE);
                button_edit_user_activity.setVisibility(VISIBLE);
                findViewById(R.id.image_view_menu_item).setVisibility(GONE);
            } else {
                button_follow_user_activity.setVisibility(VISIBLE);
                button_edit_user_activity.setVisibility(GONE);
                findViewById(R.id.image_view_menu_item).setVisibility(VISIBLE);
            }
        }
        if (trusted) {
            image_view_ringtone_activity_trusted.setVisibility(VISIBLE);
        } else {
            image_view_ringtone_activity_trusted.setVisibility(GONE);
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < response.body().getValues().size(); i++) {
                            ...
                            if (facebook != null) {
                                if (!facebook.isEmpty()) {
                                    if (facebook.startsWith("http://") || facebook.startsWith("https://")) {
                                        image_view_activity_user_facebook.setVisibility(VISIBLE);
                                    }
                                }
                            }
                        }
                            ...
                            if (twitter != null) {
                                ...
                                if (!twitter.isEmpty()) {
                                    if (twitter.startsWith("http://") || twitter.startsWith("https://")) {
                                        image_view_activity_user_twitter.setVisibility(VISIBLE);
                                    }
                                }
                            }
                        }
                            ...
                            if (instagram != null) {
                                ...
                                if (!instagram.isEmpty()) {
                                    if (instagram.startsWith("http://") || instagram.startsWith("https://")) {
                                        ...
                                        image_view_activity_user_instagram.setVisibility(VISIBLE);
                                    }
                                }
                            }
                        }
                        if (response.body().getValues().get(i).getName().equals("email")) {
                            ...
                            if (email != null) {
                                if (!email.isEmpty()) {
                                    image_view_activity_user_email.setVisibility(VISIBLE);
                                }
                            }
                        }

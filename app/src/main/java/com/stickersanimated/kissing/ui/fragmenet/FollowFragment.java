...
public class FollowFragment extends Fragment {
    ...
    private void loadInitialData() {
        if (hasLoadedOnce) return; // Optional: prevent re-loading if you navigate back and forth

        hasLoadedOnce = true;
        page = 0;
        loading = true;

        loadFollowings(); // This is your existing network call method
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PrefManager prf = new PrefManager(requireContext());
        ...
        if ("TRUE".equals(prf.getString("LOGGED"))) {
            // If the user is logged in, start loading the data.
            loadInitialData(); // Create a method for initial loading
        }
        return view;
    }
